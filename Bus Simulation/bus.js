...
using this instruction: "node bus.js" to run the program.
...
var busPosition = ["A","B","C","D","E"];//To store temporary results.

/*
carPosition stands for the bus' position.
eg. carPosition[1] = 1.20 means the bus is between stop 1 and stop 2.
	carPosition[5] = 15.40 means the bus is between stop 15 and stop 1.
*/
...
queue.enq({clock:10000,event:"showStatues"});
queue.enq({clock:5000,event:"showStatues"});
queue.enq({clock:20000,event:"showStatues"});
...
function showStatues(){
	...
	console.log("Statues in each stop");
	for(var i=1;i<=15;i++){
